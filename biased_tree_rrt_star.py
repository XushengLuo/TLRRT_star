...
import numpy as np
import sys
sys.path.insert(0, '/Users/chrislaw/Github/rrt_algorithms_develop')
...
# def biased_tree_rrt_star(workspace, path, init_label, goal_label):
def biased_tree_rrt_star():
    X_dimensions = np.array([(0, 100), (0, 100)])  # dimensions of Search Space
    # obstacles
    Obstacles = np.array([(20, 20, 40, 22), (20, 60, 40, 80), (60, 20, 80, 40), (60, 60, 80, 80)])
